...
<resources>
    ...
    <string name="cancel_connection_long">VPN desconectado</string>
    ...
    <string name="notification_title">notifications title</string>
    ...
    <string name="state_assign_ip">Atribuição de endereços IP addresses</string>
    ...
    <string name="state_wait">Aguardando resposta do servidor</string>
